...
export const BrowserProperties = () => {
  ...
  useEffect(() => {
    ...
    //desativar se for fazer um search mais elaborado
  ...
  const handleCloseSelect = () => {
    handleOpenSelect("searchIsOpen", "false");
  }
  const handleLocation = () => {
    router.push(
      `?search=${selectedLocation}&filter=${choseFilter}#properties`,
      { scroll: false }
    );
  ...
  return (
    <>
      {searchParams.get("searchIsOpen") === "true" && (
        <div
          className="fixed top-0 left-0 right-0 bottom-0 bg-black/10 z-10"
      ...
      <div className="lg:w-8/12 w-full max-w-4xl relative">
        ...
        <div className="flex items-center shadow-xl shadow-primary/10 bg-white p-3 rounded-b-lg lg:rounded-e-lg">
          ...
          <button
            ...
            className={`${
              selectedLocation !== "" ? "bg-primary" : "bg-gray-400 opacity-70"
